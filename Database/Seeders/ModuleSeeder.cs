    ...
    public static class ModuleSeeder
    {
        public static void Run(AppDbContext context)
        {
            context.Modules.AddOrUpdate(
                ...
                {
                    Id = 1,
                    Name = "Section A - Road Signs",
                    Description = "Prohibitory, warning, and mandatory road sign regulations.",
                    //Icon = "🛑",
                },
                new Module
                {
                    Id = 2,
                    Name = "Section B - Rules of the Road",
                    Description = "Speed limits, lane discipline, traffic signals, and right of way.",
                    //Icon = "🚗",
                },
                new Module
                {
                    Id = 3,
                    Name = "Section C - KEJARA & Safety",
                    Description = "Demerit point penalties, alcohol laws, and emergency procedures.",
                    //Icon = "🚦",
                },
                new Module
                {
                    Id = 4,
                    Name = "Color Blind",
                    Description = "Official Ishihara color vision screening plates.",
                    //Icon = "👁️",
                }
            );
        }
