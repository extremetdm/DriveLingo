            ...
            var quiz1 = new Quiz
            {
                ...
                Questions = new List<Question>
                {
                    new Question
                    {
                        Id = "q_s1",
                        QuizId = "quiz_signs_1",
                        Text = "What does a circular sign with a red border and a white horizontal line in the middle indicate?",
                        Options = new List<string> { "No Parking", "No Entry", "Stop", "Speed Limit Ahead" },
                        CorrectIndex = 1,
                        Explanation = "A circular sign with a red border and horizontal white bar represents the 'No Entry' command."
                    },
                    new Question
                    {
                        Id = "q_s2",
                        QuizId = "quiz_signs_1",
                        Text = "What shape and background color are warning signs in Malaysia?",
                        Options = new List<string> { "Circular with blue background", "Diamond with yellow background", "Rectangular with green background", "Triangular with red border" },
                        CorrectIndex = 1,
                        Explanation = "Warning signs (Tanda Amaran) in Malaysia are diamond-shaped with a yellow background and black border/symbols."
                    },
                    new Question
                    {
                        Id = "q_s3",
                        ...
                        Options = new List<string> { "State road direction", "Expressway destination guidance", "Warning of a sharp curve", "Hospital ahead zone" },
                        CorrectIndex = 1,
            ...
            var quiz2 = new Quiz
            {
                ...
                Questions = new List<Question>
                {
                    new Question
                    {
                        Id = "q_r1",
                        QuizId = "quiz_rules_1",
                        Text = "What is the default national speed limit on expressways in Malaysia?",
